...
-- Server generated by Zap v0.6.16 (https://github.com/red-blox/zap)
...
local unreliable = remotes:FindFirstChild("AVALOG_UNRELIABLE")
if unreliable == nil then
	unreliable = Instance.new("UnreliableRemoteEvent")
	unreliable.Name = "AVALOG_UNRELIABLE"
