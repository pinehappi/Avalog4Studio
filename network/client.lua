...
local unreliable = remotes:WaitForChild("AVALOG_UNRELIABLE")

assert(reliable:IsA("RemoteEvent"), "Expected AVALOG_RELIABLE to be a RemoteEvent")
assert(unreliable:IsA("UnreliableRemoteEvent"), "Expected AVALOG_UNRELIABLE to be an UnreliableRemoteEvent")
	...
	BulkPurchaseAvatarItems = {
		Fire = function(Value: ({ (BulkPurchaseAvatarItem) }))
			...
			for i_1 = 1, len_1 do
				...
				types.write_BulkPurchaseAvatarItem(val_1)
			end
		end,
	},
	UpdateAvatar = {
